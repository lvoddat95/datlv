...
function write_scripts()
{
	...
	wp_enqueue_script('write-swiper@8', get_template_directory_uri() . '/oxanh/utils/swiper@8/swiper-bundle.min.js', array(), WRITE_VERSION, true);
...
function write_add_slug_body_class($classes)
{
	global $post;
	if (isset($post)) {
...
add_filter('body_class', 'write_add_slug_body_class');
