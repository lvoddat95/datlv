    ...
    <div class="ci-breadcrumb-link bg-silver2 d-flex">
        <div class="container">
            <ul class="list-unstyled">
                <li class="home"><a href=ef="<?php echo esc_url(home_url('/oxanh/')); ?>">Trang chủ</a></li>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="text-left col-md-7">
                                <div class="position-relative auth-pass-inputgroup mb-3">
                                    <input type="password" class="form-control pe-5" placeholder="············"
                                        id="password-input">
                                    <button tabindex="-1" onclick="show_password(this);"
                                        class="btn btn-link position-absolute end-0 top-0 h-100 text-decoration-none text-muted show"
                                        style="width: 40px;" type="button" id="password-addon"><i
                                            class="far fz-14 fa-eye-slash align-middle"></i></button>
                                </div>
                            </div>
                        </div>
