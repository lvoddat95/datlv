                    ...
                    <div class="ci-purchase-box mb-5">
                        ...
                        <!-- <div class="row gx-2 clearfix">
                                        ...
                                        <div class="payment-block col-lg-6 col-md-6 col-sm-12">
                                            <div onclick="chose_payment(this);" class="payment-box payment-menthod-box">
                                                <div class="payment-box__icon">
                                                    <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/zalopay.svg" alt="Zalo Pay">
                                            ...
                                            <div onclick="chose_payment(this);" class="payment-box payment-menthod-box">
                                                <div class="payment-box__icon">
                                                    <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/payoo_logo.png" alt="Payoo">
                                                </div>
                                                <div class="payment-box__info">
                        ...
                        <div class="row gx-2 clearfix">
                            <div class="payment-block col-lg-6 col-md-6 col-sm-12">
                                <div onclick="chose_payment(this);" class="payment-box payment-menthod-box active">
                                    <div class="payment-box__icon">
                                        <img class="img-fluid" width="" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/banking.png" alt="Banking">
                                    </div>
                                    <div class="payment-box__info">
                            ...
                            <div class="payment-block col-lg-6 col-md-6 col-sm-12">
                                <div onclick="chose_payment(this);" class="payment-box payment-menthod-box">
                                    <div class="payment-box__icon">
                                        <img class="img-fluid" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/payment/paylater.png" alt="PayLater">
                                    </div>
                                    <div class="payment-box__info">
                                ...
                                <div id="payment-info" class="payment-info mb-5" data-info="CHUYENKHOAN" style="display: block;">
                                    <div class="d-flex flex-wrap justify-content-between">
                                        <a href="#bank-agribank" class="img-bank active" onclick="chosse_bank(this);" data-stk="1029635288" data-chinhanh="">
                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/1_Agribank.jpg" alt="">
                                        </a>
                                        <a href="#bank-bidv" class="img-bank " onclick="chosse_bank(this);" data-stk="1401206012620" data-chinhanh="">
                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/2_VCB.jpg" alt="">
                                        </a>
                                        <a href="#bank-agribank" class="img-bank " onclick="chosse_bank(this);" data-stk="16010000695086" data-chinhanh="">
                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/3_BIDV.jpg" alt="">
                                        </a>
                                        <a href="#bank-vietinbank" class="img-bank " onclick="chosse_bank(this);" data-stk="116002916355" data-chinhanh="">
                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/4_Vietinbank.jpg" alt="">
                                        </a>
                                        <a href="#bank-techcombank" class="img-bank " onclick="chosse_bank(this);" data-stk="1234567890" data-chinhanh="">
                                            <img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/bank/5_Techcombank.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="bank-info">
                        ...
                        <div class="d-flex justify-content-between mt-5">
                            <a href="<?php echo esc_url(home_url('/oxanh/b2-xem-thong-tin/')); ?>" class="btn ci-btn ci-btn-200 ci-btn-outline">
                                Quay lại
                            </a>
