                                ...
                                <div class="ci-entry-content">
                                    <div class="news-detail">
                                        ...
                                        <div class="text">
                                            ...
                                            <p style="text-align: center;"><span style="font-size: 12pt;"><img class="w-100 of-cover" height="240px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/blog03.jpg" alt="Slider"></span></p>
                                    ...
                                    <div class="comment_list">
                                        <div class="comment_item">
                                            ...
                                            <div class="comment_reply">
                                                <div class="comment_ask">
                                                    <img class="cmt_avatar" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/user.png" alt="">
                                                    <div class="cmt_info">
                    ...
                    <div class="ci-block overflow-visible">
                        ...
                        <div class="ci-slider slick-slider data-slick-slider" data-slick='{
                            ...
                            <div class="slider-item">
                                <div class="ci-blog-slider__item item-style2">
                                    <div class="ci-blog-img">
                                        <img class="w-100 of-cover" height="240px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/family3.jpg" alt="Slider">
                                    </div>
                            ...
                            <div class="slider-item">
                                <div class="ci-blog-slider__item item-style2">
                                    <div class="ci-blog-img">
                                        <img class="w-100 of-cover" height="240px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/blog03.jpg" alt="Slider">
                                    </div>
                                    <div class="ci-blog-info">
                                        <span class="sub-color fw-medium">Blog</span>
                                        <h3 class="ci-blog-info__title">
                            ...
                            <div class="slider-item">
                                <div class="ci-blog-slider__item item-style2">
                                    <div class="ci-blog-img">
                                        <img class="w-100 of-cover" height="240px" src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/blog04.jpg" alt="Slider">
                                    </div>
                                    <div class="ci-blog-info">
                                        <span class="sub-color fw-medium">Blog</span>
                                        <h3 class="ci-blog-info__title">
