                                ...
                                <div class="loadMore">
                                    <div class="central-meta new-pst item" style="display: inline-block;">
                                        <div class="new-postbox">
                                            <figure>
                                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/team-1.jpg" alt="">
                                            </figure>
                                            <div class="newpst-input">
                                                <form method="post">
                                                    <textarea rows="2" placeholder="Cảm nghĩ của bạn..."></textarea>
                            ...
                            <div class="col-lg-3">
                                <aside class="sidebar static">
                                    ...
                                    <div class="widget friend-list stick-widget">
                                        ...
                                        <ul id="people-list" class="friendz-list ps-container ps-theme-default ps-active-y" data-ps-id="e58ba484-3c83-e847-3471-80e2b01b49d9">
                                            <li>
                                                <figure>
                                        ...
                                        <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 450px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 384px;"></div></div></ul>
                                        <div class="chat-box">
                                            <div class="chat-head">
                                                <span class="status f-online"></span>
                                                <h6>Bucky Barnes</h6>
                                            ...
                                            <div class="chat-list">
                                                <ul class="ps-container ps-theme-default ps-active-y" data-ps-id="17cdcf40-101f-23de-b6f3-7f9537f72c6b">
                                                    <li class="me">
                                                ...
                                                <div class="ps-scrollbar-x-rail" style="left: 0px; bottom: 0px;"><div class="ps-scrollbar-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps-scrollbar-y-rail" style="top: 0px; height: 290px; right: 0px;"><div class="ps-scrollbar-y" tabindex="0" style="top: 0px; height: 188px;"></div></div></ul>
                                                <form class="text-box">
