...
<body>
    <div id="ci-content" class="ci-content">
        ...
        <div class="auth-wrapper" style="background-image: url(<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/slider.png);">
                        ...
                        <div class="card-body p-3 p-xl-5">
                            <div class="text-center ">
                                <a href="index.html" class="d-inline-block auth-logo">
                                    <img src="<?php echo get_stylesheet_directory_uri(); ?>/oxanh/assets/img/logo/logo-nav.png" alt="" height="50">
                                </a>
                            </div>
                            ...
                            <div class="p-2">
                                ...
                                <form action="dong-y-chinh-sach.html">
                                    ...
                                    <div class="mt-5 auth-btn-agree d-flex justify-content-center">
                                        ...
                                        <a href="javascript:void(0);" onclick="AlertMessage('#dialog-content','?php echo esc_url(home_url('/oxanh/')); ?>/')" class="btn ci-btn ci-bg-sub-color w-50 mx-2 mx-lg-4" type="submit">Đồng
                                            ý</a>
                                    </div>
